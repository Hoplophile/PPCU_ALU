...
#  Generated on:      Thu Sep 12 09:16:03 2019
#  Design:            mtm_Alu
...
set_input_delay -add_delay 50 -clock [get_clocks {clk}] [get_ports {rst_n}]
set_input_delay -add_delay 50 -clock [get_clocks {clk}] [get_ports {sin}]
set_output_delay -add_delay 50 -clock [get_clocks {clk}] [get_ports {sout}]
